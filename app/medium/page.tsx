...
export default function MediumLoad() {
  ...
  useEffect(() => {
    // Load data from the medium flights JSON file
    fetch('/data/flights-medium.json')
      ...
      .catch(error => {
        console.error('Error loading medium flights data:', error)
      })
  }, [])
      ...
      <div className="container mx-auto px-4 py-8">
        <header className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-2">
            Emirates Airlines - Medium Flight Load Dashboard
          </h1>
