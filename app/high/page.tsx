...
export default function HighLoad() {
  ...
  useEffect(() => {
    // Load data from the high flights JSON file
    fetch('/data/flights-high.json')
      ...
      .catch(error => {
        console.error('Error loading high flights data:', error)
      })
  }, [])
      ...
      <div className="container mx-4 py-8">
        <header className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-2">
            Emirates Airlines - High Flight Load Dashboard
          </h1>
